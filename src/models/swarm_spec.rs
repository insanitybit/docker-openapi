...
pub struct SwarmSpec {
    ...
    pub orchestration: Option<Box<crate::models::SwarmSpecOrchestration>>,
    #[serde(rename = "Raft", skip_serializing_if = "Option::is_none")]
    pub raft: Option<Box<crate::models::SwarmSpecRaft>>,
    #[serde(rename = "Dispatcher", skip_serializing_if = "Option::is_none")]
    pub dispatcher: Option<Box<crate::models::SwarmSpecDispatcher>>,
    #[serde(rename = "CAConfig", skip_serializing_if = "Option::is_none")]
    pub ca_config: Option<Box<crate::models::SwarmSpecCaConfig>>,
    #[serde(rename = "EncryptionConfig", skip_serializing_if = "Option::is_none")]
    pub encryption_config: Option<Box<crate::models::SwarmSpecEncryptionConfig>>,
    #[serde(rename = "TaskDefaults", skip_serializing_if = "Option::is_none")]
    pub task_defaults: Option<Box<crate::models::SwarmSpecTaskDefaults>>,
}
