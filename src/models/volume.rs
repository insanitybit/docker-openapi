...
impl Volume {
    pub fn new(name: String, driver: String, mountpoint: String, labels: ::std::collections::HashMap<String, String>, scope: Scope, options: ::std::collections::HashMap<String, String>) -> Volume {
        Volume {
            name,
            driver,
            mountpoint,
