...
pub struct DistributionInspect {
    ...
    pub descriptor: Box<crate::models::OciDescriptor>,
    /// An array containing all platforms supported by the image. 
    #[serde(rename = "Platforms")]
    pub platforms: Vec<crate::models::OciPlatform>,
}

impl DistributionInspect {
    /// Describes the result obtained from contacting the registry to retrieve image metadata. 
    pub fn new(descriptor: crate::models::OciDescriptor, platforms: Vec<crate::models::OciPlatform>) -> DistributionInspect {
        DistributionInspect {
